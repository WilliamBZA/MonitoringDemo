...
namespace ThePubSub
{
    class Program
    {
        ...
        {
            Console.Title = "ThePubSub";
            Console.SetWindowSize(65, 15);

            LoggingUtils.ConfigureLogging("ThePubSub");


            var endpointConfiguration = new EndpointConfiguration("ThePubSub");
        ...
        static void RunUserInterfaceLoop(SimulationEffects state)
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("ThePubSub Endpoint");
