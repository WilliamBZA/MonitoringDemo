...
namespace BusinessLogicBumperCars
{
    class Program
    {
        static async Task Main()
        {
            Console.Title = "BusinessLogicBumperCars";
            Console.SetWindowSize(65, 15);

            LoggingUtils.ConfigureLogging("BusinessLogicBumperCars");


            var endpointConfiguration = new EndpointConfiguration("BusinessLogicBumperCars");
        ...
        static void RunUserInterfaceLoop(SimulationEffects state)
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("BusinessLogicBumperCars Endpoint");
