...
namespace CriticalSplash
{
    class Program
    {
        static async Task Main()
        {
            Console.Title = "CriticalSplash";
            Console.SetWindowSize(65, 15);

            LoggingUtils.ConfigureLogging("CriticalSplash");


            var endpointConfiguration = new EndpointConfiguration("CriticalSplash");
        ...
        static void RunUserInterfaceLoop(SimulationEffects state)
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("CriticalSplash Endpoint");
