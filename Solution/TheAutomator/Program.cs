...
namespace TheAutomator
{
    class Program
    {
        ...
        {
            Console.Title = "TheAutomator";
            Console.SetWindowSize(65, 15);

            LoggingUtils.ConfigureLogging("TheAutomator");


            var endpointConfiguration = new EndpointConfiguration("TheAutomator");
        ...
        static void RunUserInterfaceLoop(SimulationEffects state)
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("TheAutomator Endpoint");
